        ...
        <div className="p-2 mb-2 shadow-md flex justify-center bg-gray-50">
            <div className="">
                ...
                <input
                    ...
                    />
                    <button className=" relative z-[2] flex items-center rounded-r bg-gray-50 rounded-md px-6 py-1 font-medium uppercase leading-tight shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg" onClick={()=>{
